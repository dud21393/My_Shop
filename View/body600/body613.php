...
<?php if($id){ ?>
    <div style="width: 1100px">
        <form action="../Ctl/MainCTL.php?action=610&bnum=<?=$boardView[0]?>&page=<?=$page?>" style="float: left; margin-left: 100px" method="post">
        ...
        <form action="../Ctl/MainCTL.php?action=614&bnum=<?=$boardView[0]?>" style="float: right; margin-right: 30px" method="post">
...
if($reply_list)
{
    ...
    {
        echo "<div style='margin-left: 100px; margin-bottom: 10px; width: 1000px'>";
        echo "<div>";
