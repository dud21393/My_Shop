...
$board_serch['all']=isset($_REQUEST['all'])?$_REQUEST['all']:null;
    ...
    <table border="1" width="800px" align="center">
            ...
            for ($iCount = 0; $iCount < count($boardList); $iCount++) {
                ...
                ?>
                <td><a href='../Ctl/MainCTL.php?action=618&bnum=<?=$boardList[$iCount][0]?>&hit=true&page=<?=$boardpageInfo['current_page']?>'>
                        <?php
            ...
            <?php    echo "<td colspan='2' align='center'>" . $boardList[$iCount][5] . "</td>"; //날짜
